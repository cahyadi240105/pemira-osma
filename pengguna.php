                        ...
                        <div class="col-lg-12 grid-margin stretch-card mx-auto">
                            <div class="card">
                                <div class="card-body">
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="#" data-toggle="modal" data-target="#modalEdit<?= $row['id_user']; ?>">
                                                                <label class="badge badge-warning text-white">Edit</label>
                                                            </a> |
                                                            <a href="" data-toggle="modal" data-target="#modalHapus<?= $row['id_user']; ?>">
                                    ...
                                    ?>
                                        <div class="modal fade" id="modalHapus<?= $row['id_user']; ?>" tabindex="-1" role="dialog">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        <a href="hapus_user.php?id=<?= $row['id_user']; ?>" class="btn btn-danger">
